...
window.QUESTIONS = [
  {
    ...
    options: [
      { text: '맛있는 거 먹어~ 하고 신경 안 쓴다', scores: { obsession: 1 } },
      { text: '누구랑? 정도만 물어보고 넘어간다', scores: { obsession: 2 } },
      { text: '괜찮다고 하면서도 은근 카톡 확인한다', scores: { obsession: 3 } },
      { text: '밥 먹는 동안 계속 연락이 오는지 체크한다', scores: { obsession: 4 } },
      { text: '인스타 위치 태그 뜨나 실시간 확인한다', scores: { obsession: 5 } },
    ],
  },
  {
    question: '연인의 핸드폰을 볼 수 있는 상황이면?',
    options: [
      { text: '관심 없다. 내 폰도 안 보는데', scores: { obsession: 1 } },
      { text: '살짝 궁금하지만 절대 안 본다', scores: { obsession: 2 } },
      { text: '잠금화면 알림 정도는 슬쩍 본다', scores: { obsession: 3 } },
      { text: '카톡 목록까지는 확인하고 싶다', scores: { obsession: 4 } },
      { text: '최근 통화 기록이랑 카톡 다 확인한다', scores: { obsession: 5 } },
    ],
  },
  {
    ...
    options: [
      ...
      { text: '왜 나는 안 올려? 하고 넌지시 물어본다', scores: { obsession: 3 } },
      { text: '좋아요 누른 사람들 한 명씩 확인한다', scores: { obsession: 4 } },
      { text: '이성이 댓글 달면 누군지 프로필까지 조사한다', scores: { obsession: 5 } },
      { text: '나도 일부러 다른 사람이랑 찍은 사진 올려서 반응 본다', scores: { obsession: 4 } },
    ],
  },
  {
    question: '연인이 전 애인 얘기를 하면?',
    options: [
      { text: '과거일 뿐이지~ 쿨하게 들어준다', scores: { obsession: 1 } },
      { text: '살짝 신경 쓰이지만 티는 안 낸다', scores: { obsession: 2 } },
      { text: '슬쩍 비교하면서 나한테 더 잘해주길 바란다', scores: { obsession: 3 } },
      { text: '전 애인 SNS를 검색해본다', scores: { obsession: 4 } },
      { text: '전 애인 사진부터 스펙까지 전부 조사 완료한다', scores: { obsession: 5 } },
    ],
  },
  {
    question: '연인이 나 말고 다른 사람과 있을 때 더 웃는 것 같으면?',
    options: [
      { text: '사교적인 거겠지, 별 생각 없다', scores: { obsession: 1 } },
      { text: '조금 삐지지만 금방 풀린다', scores: { obsession: 2 } },
      { text: '나한테는 왜 그렇게 안 웃어주냐고 넌지시 말한다', scores: { obsession: 3 } },
      { text: '왜 나한텐 그렇게 안 웃어? 하고 따진다', scores: { obsession: 4 } },
      { text: '그 사람이 누군지 몰래 파악한다', scores: { obsession: 4 } },
      { text: '그 사람이랑 연락하는지 확인하고 싶어진다', scores: { obsession: 5 } },
    ],
  },
  {
    question: '연인의 카톡 답장이 평소보다 1시간 늦으면?',
    options: [
      { text: '바쁜가 보다~ 나도 내 할 일 한다', scores: { obsession: 1 } },
      { text: '뭐하나 궁금하지만 기다린다', scores: { obsession: 2 } },
      { text: '접속 시간 확인하러 프로필 들어간다', scores: { obsession: 3 } },
      { text: '왜 안 읽어? 하고 한 번 더 보낸다', scores: { obsession: 4 } },
      { text: '3분마다 읽었는지 확인하고 전화까지 고민한다', scores: { obsession: 5 } },
    ],
  },
  {
    question: '연인이 동성 친구들이랑 놀러 간다고 하면?',
    options: [
      { text: '재밌게 놀아~ 진심으로 응원한다', scores: { obsession: 1 } },
      { text: '사진 보내줘~ 하고 가볍게 부탁한다', scores: { obsession: 2 } },
      { text: '누구누구 가는지 물어보고 정리한다', scores: { obsession: 3 } },
      { text: '중간중간 연락 오는지 체크한다', scores: { obsession: 4 } },
      { text: '진짜 동성 친구만 있는지 확인하고 싶다', scores: { obsession: 5 } },
    ],
  },
  {
    question: '연인이 나를 팔로우하는 이성의 게시물에 좋아요를 누르면?',
    options: [
      { text: '좋아요 하나로 뭘 그래~ 신경 안 쓴다', scores: { obsession: 1 } },
      { text: '약간 거슬리지만 넘어간다', scores: { obsession: 2 } },
      { text: '그 사람 프로필 한번 구경한다', scores: { obsession: 3 } },
      { text: '그 사람이랑 DM 하는 건 아닌지 의심된다', scores: { obsession: 4 } },
      { text: '좋아요 기록을 전부 뒤져서 패턴 분석한다', scores: { obsession: 5 } },
      { text: '은근슬쩍 "그 사람 아는 사이야?" 하고 떠본다', scores: { obsession: 3 } },
    ],
  },
  {
    question: '연인과 함께인데 연인이 계속 폰을 보면?',
    options: [
      { text: '나도 내 폰 보면서 각자 시간 보낸다', scores: { obsession: 1 } },
      { text: '재밌는 거 보여줘~ 하고 자연스럽게 대화한다', scores: { obsession: 2 } },
      { text: '누구랑 카톡하는지 슬쩍 보려고 한다', scores: { obsession: 3 } },
      { text: '나한테 집중 안 하는 거 불만이라 말한다', scores: { obsession: 4 } },
      { text: '화면에 뭐가 떠있는지 반사적으로 확인한다', scores: { obsession: 5 } },
    ],
  },
  {
    question: '연인이 "오늘 바빠서 못 만나"라고 하면?',
    options: [
      { text: '알겠어~ 다음에 보자! 쿨하게 수락한다', scores: { obsession: 1 } },
      { text: '아쉽지만 이해하고, 자기 할 일 한다', scores: { obsession: 2 } },
      { text: '뭐가 바쁜데? 하고 이유를 캐묻는다', scores: { obsession: 3 } },
      { text: '혹시 나 말고 다른 사람 만나는 건 아닌지 궁금해진다', scores: { obsession: 3 } },
      { text: '진짜 바쁜 건지 다른 약속인지 추리한다', scores: { obsession: 4 } },
      { text: '인스타 스토리 올리나 밤새 감시한다', scores: { obsession: 5 } },
    ],
  },
  {
    question: '연인의 카톡 프로필 사진이 바뀌면?',
    options: [
      { text: '새 사진 이쁘다~ 하고 끝낸다', scores: { obsession: 1 } },
      { text: '어디서 찍은 거야? 가볍게 물어본다', scores: { obsession: 2 } },
      { text: '누가 찍어줬는지가 더 궁금하다', scores: { obsession: 3 } },
      { text: '배경이 어딘지 분석해서 누구랑 갔는지 추리한다', scores: { obsession: 4 } },
      { text: '이전 프로필 사진을 캡처해두고 비교 분석한다', scores: { obsession: 5 } },
    ],
  },
  {
    question: '연인이 이성에게 친절하게 대하는 걸 보면?',
    options: [
      { text: '매너 좋은 사람이라 자랑스럽다', scores: { obsession: 1 } },
      { text: '조금 질투나지만 내색 안 한다', scores: { obsession: 2 } },
      { text: '나한테만 더 잘해주면 좋겠다고 말한다', scores: { obsession: 3 } },
      { text: '그 이성한테 왜 그렇게까지 친절한 건지 따진다', scores: { obsession: 4 } },
      { text: '앞으로 그 사람이랑 만나지 말라고 한다', scores: { obsession: 5 } },
    ],
  },
  {
    question: '연인이 새벽에 갑자기 접속 중이면?',
    options: [
      { text: '잠이 안 오나 보다~ 관심 없다', scores: { obsession: 1 } },
      { text: '나도 깨어있으면 연락해볼까? 정도', scores: { obsession: 2 } },
      { text: '누구랑 채팅하는 거지? 궁금해진다', scores: { obsession: 3 } },
      { text: '그 시간에 접속한 이유를 은근히 다음 날 물어본다', scores: { obsession: 3 } },
      { text: '바로 카톡 보내서 뭐 하냐고 물어본다', scores: { obsession: 4 } },
      { text: '상대 접속 패턴을 기억해뒀다가 나중에 언급한다', scores: { obsession: 5 } },
    ],
  },
  {
    question: '연인의 과거 연애 사진이 SNS에 남아있으면?',
    options: [
      { text: '과거니까 상관없다. 안 본다', scores: { obsession: 1 } },
      { text: '살짝 불편하지만 지우라고까진 안 한다', scores: { obsession: 2 } },
      { text: '슬쩍 지워달라고 넌지시 힌트준다', scores: { obsession: 3 } },
      { text: '확실하게 지워달라고 요청한다', scores: { obsession: 4 } },
      { text: '사진 속 전 애인이 누군지 다 파악 완료한다', scores: { obsession: 5 } },
    ],
  },
  {
    question: '여행 중 연인과 연락이 안 되면?',
    options: [
      { text: '여행 즐기느라 바쁘겠지~ 기다린다', scores: { obsession: 1 } },
      { text: '하루 정도는 괜찮지만 좀 보고 싶다', scores: { obsession: 2 } },
      { text: '왜 연락이 안 되지? 불안해진다', scores: { obsession: 3 } },
      { text: '같이 간 친구한테 DM 보내서 슬쩍 안부 물어본다', scores: { obsession: 3 } },
      { text: '친구한테 연락해서 상황 파악을 시도한다', scores: { obsession: 4 } },
      { text: '최악의 시나리오 상상하며 전화 폭격한다', scores: { obsession: 5 } },
    ],
  },
];
